  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 text-white">
      <div className="w-full max-w-[360px] panel p-8 shadow-[0_0_60px_rgba(106,166,255,0.22)]">
        <div className="flex justify-center mb-3 text-tx">
          {orgLogoUrl ? (
        ...
        {orgTagline && (
          <p className="text-[11px] text-center text-sub italic mb-5">
            {orgTagline}
          </p>
        )}
        <p className="text-[12px] text-center text-sub mb-6 uppercase tracking-[0.18em]">
          Нэвтрэх
        </p>
        ...
        <p className="text-[10px] text-center text-sub/60 mt-6 uppercase tracking-wider">
          {orgName}
        </p>
      </div>
    </main>
